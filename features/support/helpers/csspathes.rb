class Csspathes
  ...
  def initialize
    ...
    @homepage_content_navi_burger_category_path = case 
      # chefworks is not working with mobile
      when "#{@env_shop}".match(/chefworks/) && "#{@env_country}".match(/ded/) then      '.entry--menu-left > a > i'
    ...
    @navigation_hovermenu_path = case
      when "#{@env_shop}".match(/pulsiva/) && "#{@env_country}".match(/it/) then       '.menu--container.menu--is-active > div.content--wrapper.has--content > div > ul > li:nth-child(1) > a'
      when "#{@env_shop}".match(/pulsiva/) && "#{@env_country}".match(/se/) then       '.menu--list-item'
      when "#{@env_shop}".match(/pulsiva/) && "#{@env_country}".match(/no/) then       '.menu--list-item'
      ...
      when "#{@env_shop}".match(/pulsiva/) && "#{@env_country}".match(/[a-z]{2}/) then     '.advanced-menu'
    ...
    @links_context_path = case 
      when "#{@env_shop}".match(/pulsiva/) && "#{@env_country}".match(/[a-z]{2}/) then      '.navigation--entry.entry--service.has--drop-down.js--is--dropdown-active > ul'
      when "#{@env_shop}".match(/vega/) && "#{@env_country}".match(/[a-z]{2}/) then         '.listing-header-container'        
      when "#{@env_shop}".match(/v_jobeline/) && "#{@env_country}".match(/[a-z]{2}/) then   '.listing-header-container'        
      when "#{@env_shop}".match(/hotelwaesche/) && "#{@env_country}".match(/[a-z]{2}/) then '.listing-header-container'        
      when "#{@env_shop}".match(/hw_jobeline/) && "#{@env_country}".match(/[a-z]{2}/) then  '.listing-header-container'        
      when "#{@env_shop}".match(/chefworks/) && "#{@env_country}".match(/de/) then          'div.navigation--entry.entry--service.has--drop-down.js--is--dropdown-active > ul'
      when "#{@env_shop}".match(/export/) && "#{@env_country}".match(/[a-z]{2}/) then       'div.navigation--entry.entry--service.has--drop-down.js--is--dropdown-active > ul'
    ...
    @account_registerform_taxid_path = case #umsatzsteuernummer (UID)
      when "#{@env_shop}".match(/v_jobeline/) && "#{@env_country}".match(/nl/) then       '#register_billing_emgroup_commercial_register_nr'
      when "#{@env_shop}".match(/v_jobeline/) && "#{@env_country}".match(/no/) then       '#register_billing_emgroup_commercial_register_nr'
      when "#{@env_shop}".match(/vega/) && "#{@env_country}".match(/nl/) then            '#register_billing_emgroup_commercial_register_nr'
    ...
    @account_payment_cashOnDelivery_path = case 
      when "#{@env_shop}".match(/pulsiva/) && "#{@env_country}".match(/ch/) then         '#payment_mean5'
      when "#{@env_shop}".match(/pulsiva/) && "#{@env_country}".match(/fr/) then         '#payment_mean5'
      when "#{@env_shop}".match(/pulsiva/) && "#{@env_country}".match(/no/) then         '#payment_mean5'
      when "#{@env_shop}".match(/pulsiva/) && "#{@env_country}".match(/se/) then         '#payment_mean5'
      when "#{@env_shop}".match(/pulsiva/) && "#{@env_country}".match(/be/) then         '#payment_mean5'
      when "#{@env_shop}".match(/pulsiva/) && "#{@env_country}".match(/es/) then         '#payment_mean3'
      when "#{@env_shop}".match(/pulsiva/) && "#{@env_country}".match(/[a-z]{2}/) then   '#payment_mean3'
      when "#{@env_shop}".match(/vega/) && "#{@env_country}".match(/de/) then            '#payment_mean4'
      when "#{@env_shop}".match(/vega/) && "#{@env_country}".match(/fr/) then            '#payment_mean4'
      when "#{@env_shop}".match(/vega/) && "#{@env_country}".match(/be/) then            '#payment_mean4'
      when "#{@env_shop}".match(/vega/) && "#{@env_country}".match(/no/) then            '#payment_mean4'
      when "#{@env_shop}".match(/vega/) && "#{@env_country}".match(/se/) then            '#payment_mean4'
      when "#{@env_shop}".match(/vega/) && "#{@env_country}".match(/[a-z]{2}/) then      '#payment_mean3'
      when "#{@env_shop}".match(/v_jobeline/) && "#{@env_country}".match(/de/) then      '#payment_mean5'
      when "#{@env_shop}".match(/v_jobeline/) && "#{@env_country}".match(/fr/) then      '#payment_mean4'
      when "#{@env_shop}".match(/v_jobeline/) && "#{@env_country}".match(/be/) then      '#payment_mean4'
      when "#{@env_shop}".match(/v_jobeline/) && "#{@env_country}".match(/no/) then      '#payment_mean4'
      when "#{@env_shop}".match(/v_jobeline/) && "#{@env_country}".match(/se/) then      '#payment_mean4'
      when "#{@env_shop}".match(/vega/) && "#{@env_country}".match(/se/) then            '#payment_mean4'
      when "#{@env_shop}".match(/chefworks/) && "#{@env_country}".match(/[a-z]{2}/) then '#payment_mean3'
    ...
    @account_accountinfo_billaddresschange_button_appear_path = case 
      when "#{@env_shop}".match(/pulsiva/) && "#{@env_country}".match(/[a-z]{2}/) then   '.panel--actions > a'
      when "#{@env_shop}".match(/v_jobeline/) && "#{@env_country}".match(/[a-z]{2}/) then   '.panel--actions > a'
    ...
    @checkout_step_payment_path = case 
      when "#{@env_shop}".match(/export/) && "#{@env_country}".match(/[a-z]{2}/) then    '.step--register.is--active'
      else '.step--register.is--active' 
    end
    @checkout_step_confirm_path = case 
      when "#{@env_shop}".match(/export/) && "#{@env_country}".match(/[a-z]{2}/) then    '.step--confirm.is--active'
    ...
    @checkout_payment_options_path = case 
      when "#{@env_shop}".match(/pulsiva/) && "#{@env_country}".match(/[a-z]{2}/) then   '.shipping-payment--information > div:nth-child(1) > div > div'
    ...
    @checkout_payment_delivery_standard_radio_path = case 
      when "#{@env_shop}".match(/pulsiva/) && "#{@env_country}".match(/de/) then          ".dispatch--method > div > .radio.auto_submit"
