...
When(/^I click the link to my account$/) do
  ...
  #pathes
  links_account_path = websitebasics.links_account_path  
  #click button
...
When(/^I touch the link to my account$/) do
  #pathes
  links_account_icon_path = websitebasics.links_account_icon_path  
  #click button
...
Then(/^I should be on the accountpage$/) do
  ...
  url_part = 'account'
  #pathes
  links_registration_path = websitebasics.links_registration_path  
  #wait for path
...
Then(/^I should be on the accountpage for mobile$/) do
  ...
  url_part = 'account'
  #pathes
  links_accordion_path = websitebasics.links_registration_path  
  #wait for path
...
When(/^I click the link to my notes$/) do
  ...
  start_url = current_url
  #pathes
  links_notes_path = websitebasics.links_notes_path  
  #click button
...
Then(/^I should be on the notepage of mobile$/) do
  #pathes
  account_accountpage_welcome_path = websitebasics.account_accountpage_welcome_path
  #wait for path
...
When(/^I click the link of the cart$/) do
  ...
  start_url = current_url
  #pathes
  links_cart_symbol_path = websitebasics.links_cart_symbol_path  
  #click button
...
Then(/^I should see the sidebar of the product cart$/) do
  #pathes
  links_cart_sidebar_path = websitebasics.links_cart_sidebar_path  
  #wait for path
...
When(/^I click the link to edit the cart$/) do
  #pathes
  links_cart_button_path = websitebasics.links_cart_button_path  
  #click button
...
Then(/^I should be on the page of the productcart$/) do
  homepage_product_cart_hint_content_path = websitebasics.homepage_product_cart_hint_content_path
...
When(/^I click the link of help$/) do
  #pathes
  links_service_path = websitebasics.links_service_path  
  #click button
...
Then(/^I should see a contextmenu$/) do
  #pathes
  links_context_path = websitebasics.links_context_path
...
When(/^I touch the link for infos of the company$/) do
  links_about_path = websitebasics.links_about_path
  links_imprint_path = websitebasics.links_imprint_path
  #click about
...
Then(/^I should see the infosite$/) do
  links_info_headline = websitebasics.links_info_headline
